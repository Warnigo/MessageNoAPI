...
import closed from '../../icons/back.png'
      ...
      <div class="flex flex-col flex-auto h-full w-3/4 flex-shrink-0">
        ...
        >
          <div class="border px-5 rounded-xl my-5">
            <div class="flex py-3 icon-div">
              <Link to={"/"}>
                <img src={closed} className='close-icon' />
              </Link>
              ...
              <div className="px-2 w-full">
                <div className='flex justify-between'>
                  <div className="">
                    ...
                    <h1 class="text-xs  text-gray-500">Online</h1>
                  </div>
          ...
          >
            ...
            <div class="ml-4 flex gap-3 px-6">
              ...
              <button class="flex items-center justify-center rounded-xl text-white py-1 flex-shrink-0">
